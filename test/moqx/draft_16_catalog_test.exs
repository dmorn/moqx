defmodule MOQX.Draft16CatalogTest do
  ...
  for track_name <- ["video", "catalog"] do
    test "emits opaque #{track_name} objects in arrival order with subgroup boundaries" do
      ...
      track = %MOQX.TrackRef{namespace: ["moqtail", "testsrc"], track: track_name}

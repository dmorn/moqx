defmodule TransportBench.QuicerSelfPair do
  @moduledoc false

  alias MOQX.Transport
  alias MOQX.Transport.Profile

  @script "bench/transport/scripts/quicer_self_pair.exs"
  @script_version "v1"
  ...
  defp command_string(argv), do: Enum.join(["mix", "run", @script, "--" | argv], " ")
...
TransportBench.QuicerSelfPair.main(System.argv())

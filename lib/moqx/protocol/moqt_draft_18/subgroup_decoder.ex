defmodule MOQX.Protocol.MOQTDraft18.SubgroupDecoder do
  @moduledoc "Incremental decoder for one MOQT draft-18 subgroup stream."
  ...
  defp valid_header_type(type)
       when type in 0x10..0x15 or type in 0x18..0x1D or type in 0x30..0x35 or
              type in 0x38..0x3D or type in 0x50..0x55 or type in 0x58..0x5D or
              type in 0x70..0x75 or type in 0x78..0x7D,
       do: :ok
